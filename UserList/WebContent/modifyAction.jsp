...
<body>
 <%
        ...
        int result = userDAO.update(Integer.parseInt(request.getParameter("idx")), request.getParameter("userID"),request.getParameter("userPass"),request.getParameter("userName"));       
