    ...
    <form action="ModifyUserAction.jsp" method="post">
        ...
        <div class="form-group">
        	<div class="input-group">
  				...
  				<input type="text" class="form-control" name="userID" value="<%=(String)session.getAttribute("userID")%>" readOnly>
			</div>
        </div>
        ...
        <div class="form-group">
        	<div class="input-group">
  				...
  				<input type="text" class="form-control" name="userEmail" placeholder="UserEmail" value="<%= user.get(0).getUserEmail() %>" required="required">
			</div>
        </div>
